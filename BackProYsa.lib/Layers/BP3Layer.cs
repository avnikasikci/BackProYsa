...
{
    [Serializable]
    public class BP3Layer<T> : IBackPropagation<T> where T : IComparable<T>
    {
        ...
        public void BackPropagate()
        {
            ...
            //Gizli katmanın hatasını düzeltin
            ...
            //Girdi katmanın hatasını düzeltin
            ...
            //Üçüncü Katmanın Ağırlıklarını Güncelle           
        ...
        public void ForwardPropagate(double[] pattern, string output)
        {
            ...
            //İkinci(Gizli) Katmanın Girdi ve Çıktılarını Hesapla            
            for (i = 0; i < HiddenNum; i++)
            {
                total = 0.0;
                for (j = 0; j < InputNum; j++)
            ...
            //Üçüncü(Çıkış) Katmanın Girdilerini, Çıktılarını, Hedeflerini ve Hatalarını Hesaplayın
            for (i = 0; i < OutputNum; i++)
            {
                total = 0.0;
                for (j = 0; j < HiddenNum; j++)
        ...
        public void Recognize(double[] Input, ref string MatchedHigh, ref double OutputValueHight, ref string MatchedLow, ref double OutputValueLow)
        {
            ...
            ///Gizli Katmanın Giriş ve Çıkışlarını Hesapla
